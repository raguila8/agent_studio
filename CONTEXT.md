...
**Preview Site**:
A Generated Site in its pre-conversion lifecycle stage. Hosted on `{slug}.preview.youragency.com`, has open `/admin` access to Tina for the MVP, no custom domain. Shown to Prospects as the lead magnet.
